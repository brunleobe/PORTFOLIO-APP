    ...
    <div className="glass-card group overflow-hidden flex flex-col h-full border border-textMain/10">
      ...
      <div className="flex-grow flex flex-col">
        ...
        <div className="flex items-center gap-4 mt-auto">
          <a href={project.demoUrl} className="text-sm font-medium text-textMain bg-slate-900/5 dark:bg-white/10 hover:bg-primary-600 hover:text-white px-4 py-2 rounded-lg transition-colors">
            Live Demo
          </a>
          <a href={project.githubUrl} className="text-sm font-medium text-textMuted hover:text-textMain transition-colors">
            GitHub
          </a>
        </div>
      </div>
